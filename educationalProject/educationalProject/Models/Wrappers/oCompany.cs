...
namespace educationalProject.Models.Wrappers
{
    public class oCompany : Company
    {
        public static string getSelectCompanyByJoinCommand()
        {
            ...
            "{16},{17} " +
            "from {18},{0},{19} where {1} = {20} and {18}.{21} = {19}.{22} ",
            /**tablename 0 **/ FieldName.TABLE_NAME, /**iden 1**/ FieldName.COMPANY_ID, User_type.FieldName.USER_TYPE_NAME, FieldName.USERNAME,
