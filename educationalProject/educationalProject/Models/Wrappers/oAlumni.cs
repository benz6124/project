...
namespace educationalProject.Models.Wrappers
{
    public class oAlumni : Alumni
    {
        public static string getSelectAlumniByJoinCommand()
        {
            ...
            "from {30},{0},{31} where {0}.{1} = {30}.{32} and {30}.{33} = {31}.{34} ",
            /**tablename 0 **/ ExtraFieldName.TABLE_NAME, /**iden 1**/ FieldName.USER_ID, User_type.FieldName.USER_TYPE_NAME, FieldName.USERNAME,
