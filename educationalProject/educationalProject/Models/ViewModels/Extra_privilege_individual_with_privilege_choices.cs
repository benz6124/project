...
{
    public class Extra_privilege_individual_with_privilege_choices
    {
        private int _title_code;
        private string _name;
        private string _curri_id;
        private List<User_privilege> _privilege_list;
        private List<Privilege_choice> _choices;

        public List<User_privilege> privilege_list { get { return _privilege_list; } set { _privilege_list = value; } }
        ...
        public Extra_privilege_individual_with_privilege_choices()
        {
            privilege_list = new List<User_privilege>();
